...
namespace Calc
{
    public partial class Form1 : Form
    {
        ...
        decimal? num1, num2;
        char action;
        bool toclear = false, cleared = false, torewrite = false, canrewrite = false;
        public Form1()
        {
            InitializeComponent();
        }
        void dii(decimal a) 
        {
            if (toclear) { label1.Text = ""; toclear = false; cleared = true; }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (num1 + num2 == decimal.Parse(label1.Text) || torewrite)
            {
            ...
            {
                if (cleared) num1 += decimal.Parse(label1.Text);
                label2.Text = num1.ToString() + " " + action;
        ...
        {
            if (ActionToDo(num1, num2) == null) return;
            if (torewrite)
            {
            ...
            else if ((cleared && num2 != null) || num2 == null)
            {
                num2 = decimal.Parse(label1.Text);
